...
import com.example.bottomnavigation.utils.DensityUtil;
...
public class FaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public FaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTipTextSize = array.getDimensionPixelSize(R.styleable.FaceView_tip_text_size, DensityUtil.sp2px(context, 12));
        array.recycle();
    ...
    private void initHolder(Context context) {
        ...
        //初始化值
        margin = (int) net.csdn.roundview.util.DensityUtil.dip2px(context, 60);
        mBgArcWidth = net.csdn.roundview.util.DensityUtil.dip2px(context, 5);
        ...
        mTextBgPaint.setColor(getResources().getColor(R.color.sec_transparent));
